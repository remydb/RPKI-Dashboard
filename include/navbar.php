...
?>
  <div class='navbar navbar-inverse navbar-fixed-top'>
    <div class='navbar-inner nav-collapse' style="height: auto;">
      <div class='container'>
        <ul class="nav">
          <li <?php if ($pagename == 'index.php'){ echo'class="active"';}?>><a href="index.html">Home</a></li>
          ...
          <li <?php if ($pagename == 'ipcomp.php'){ echo'class="active"';}?>><a href="ipcomp.html">IPv4/6</a></li>
          ...
          <li <?php if ($pagename == 'validitytables.php'){ echo'class="active"';}?>><a href="validitytables.html">RPKI routes</a></li>
